...
nome_arquivo = PASTA_OUTPUT / "relatorio_trelica_pratt.txt"

with open(nome_arquivo, "w", encoding="utf-8") as arq:
    arq.write("=====================================================\n")
    arq.write("RELATÓRIO DE RESULTADOS - TRELIÇA PRATT\n")
...
plt.title(f"Treliça Pratt original e deformada (escala automática = {ESCALA:.2f})")
plt.show()